...
/*
 * Component shows table with showings on which you can buy a ticket.
 * Table shows information about: movie title, date, time, reserved/all seats, buy ticket button
 * Pressing 'buy ticket' opens window with hall, where you can choose a seat beside reserved seats
 * and form, where you can put necessery information.
*/
                ...
                <div className="showings-table">
                    <table className="table">
                        <thead className="thead">
                            ...
                            <th scope="col">Seats <p class="small-seats-info">reserved/all</p></th>
                            <th scope="col"></th>
                            </tr>
                        </thead>
